...
public class PaymentServiceTest {
    ...
    void setUp() {
        ...
        testBillDto = new BillDto( testUser.getId(), "MTR-456", "john.doe@email.com", new BigDecimal("123.98"),
    ...
    void createBill_WithValidData_ReturnsCreatedBill() {
        // Given
        BillDto newBillDto = new BillDto(testUser.getId(), "MTR-876", "john.doe@email.com", new BigDecimal("99.99"),
